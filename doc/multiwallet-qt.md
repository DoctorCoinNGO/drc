...
Only requiring some minor changes is drc.cpp.
...
Changes to drc.cpp
----------------------
drc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
