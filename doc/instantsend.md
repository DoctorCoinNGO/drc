...
This mechanism has been integrated into Bitcore-Node-DRC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/drccoin/insight-api-drc#web-socket-api](https://github.com/drccoin/insight-api-drc#web-socket-api) 
* API: [https://github.com/drccoin/insight-api-drc#instantsend-transactions](https://github.com/drccoin/insight-api-drc#instantsend-transactions) 
...
By default, the DRC Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DRC Core daemon:
