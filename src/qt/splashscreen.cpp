    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextDRC   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The DRC Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextDRC);
