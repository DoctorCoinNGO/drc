    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DRC-light"), QVariant("light"));
    ui->theme->addItem(QString("DRC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DRC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DRC-traditional"), QVariant("trad"));
