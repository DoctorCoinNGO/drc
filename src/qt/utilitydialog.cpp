    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DRC Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DRC Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  drc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DRC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an drctive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 DRC, 0.1 DRC, 1 DRC and 10 DRC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://drccoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://drccoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DRC Core is shutting down...") + "<br /><br />" +
