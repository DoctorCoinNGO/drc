    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DRC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DRC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and drc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DRC Core"), this);
    aboutAction->setStatusTip(tr("Show information about DRC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DRC Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DRC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DRC addresses"));
    ...
    openAction->setStatusTip(tr("Open a drc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DRC Core help message to get a list with possible DRC Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DRC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DRC network", "", count));
}
...
{
    QString strTitle = tr("DRC Core"); // default title
