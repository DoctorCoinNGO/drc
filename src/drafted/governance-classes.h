 ...
 *
 *   // network
 *   CDRCNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.drccoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDRCNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DRCNetwork
// //   -- signature requirements : Key1(User)
// class CDRCNetworkVariable : public CGovernanceObject
// {
// private:
