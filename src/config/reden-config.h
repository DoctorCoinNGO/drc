/* src/config/drc-config.h.  Generated from drc-config.h.in by configure.  */
/* src/config/drc-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The DRC Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "DRC Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/DRC/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DRC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DRC Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "drccore"
