...
2. run drcd with -printalert or -sendalert like this:
   /path/to/drcd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see http://www.doctorcoin.cc/";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/DRC Core:0.12.0.58/"));
